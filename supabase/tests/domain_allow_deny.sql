...
INSERT INTO auth.users (
    ...
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000a0'::uuid, 'authenticated', 'authenticated', 't64.global@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T64 Global","document_number":"94000000","role":"global"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000d1'::uuid, 'authenticated', 'authenticated', 't64.director.a@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T64 Director A","document_number":"94000001","role":"director"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000d3'::uuid, 'authenticated', 'authenticated', 't64.director.b@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T64 Director B","document_number":"94000003","role":"director"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000c1'::uuid, 'authenticated', 'authenticated', 't64.coordinador.a@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T64 Coordinador A","document_number":"94000004","role":"coordinador"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000e1'::uuid, 'authenticated', 'authenticated', 't64.psicologo.a@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T64 Psicologo A","document_number":"94000005","role":"psicologo"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000e2'::uuid, 'authenticated', 'authenticated', 't64.psicologo.b@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T64 Psicologo B","document_number":"94000006","role":"psicologo"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000f1'::uuid, 'authenticated', 'authenticated', 't64.docente.a@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T64 Docente A","document_number":"94000007","role":"docente"}', now(), now());
