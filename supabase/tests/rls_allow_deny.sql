...
INSERT INTO auth.users (
    ...
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000a0'::uuid, 'authenticated', 'authenticated', 't60.global@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T60 Global","document_number":"90000000","role":"global","institution_code":"T60-A"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000d1'::uuid, 'authenticated', 'authenticated', 't60.director.a@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T60 Director A","document_number":"90000001","role":"director","institution_code":"T60-A"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000d2'::uuid, 'authenticated', 'authenticated', 't60.admin.a@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T60 Admin A","document_number":"90000002","role":"admin_ie","institution_code":"T60-A"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000c1'::uuid, 'authenticated', 'authenticated', 't60.coordinador.a@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T60 Coordinador A","document_number":"90000003","role":"coordinador","institution_code":"T60-A"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000e1'::uuid, 'authenticated', 'authenticated', 't60.psicologo.a@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T60 Psicologo A","document_number":"90000004","role":"psicologo","institution_code":"T60-A"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000f1'::uuid, 'authenticated', 'authenticated', 't60.docente.a@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T60 Docente A","document_number":"90000005","role":"docente","institution_code":"T60-A"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000e2'::uuid, 'authenticated', 'authenticated', 't60.psicologo.b@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T60 Psicologo B","document_number":"90000006","role":"psicologo","institution_code":"T60-B"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000d3'::uuid, 'authenticated', 'authenticated', 't60.director.b@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T60 Director B","document_number":"90000007","role":"director","institution_code":"T60-B"}', now(), now()),
    ('00000000-0000-0000-0000-000000000000', 'a9000000-0000-4000-8000-0000000000c2'::uuid, 'authenticated', 'authenticated', 't60.coordinador.b@test.local', crypt('x', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"T60 Coordinador B","document_number":"90000008","role":"coordinador","institution_code":"T60-B"}', now(), now());
